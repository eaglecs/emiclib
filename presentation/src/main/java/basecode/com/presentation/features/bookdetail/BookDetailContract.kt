...
class BookDetailContract {
    interface View : ViewMvp, ViewSupportLoading {
        ...
        fun getBookInfoSuccess(lstPathResult: List<String>, title: String, author: String, publisher: String, publishYear: String, shortDescription: String, copyNumberResult: String, linkShare: String)
