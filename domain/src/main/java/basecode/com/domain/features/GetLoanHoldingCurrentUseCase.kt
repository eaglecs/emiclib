...
class GetLoanHoldingCurrentUseCase(useCaseExecution: UseCaseExecution, private val appRepository: AppRepository) : UseCaseOutput<List<BookBorrowResponse>, ErrorResponse>(useCaseExecution) {
    override fun buildUseCaseObservable(): Observable<List<BookBorrowResponse>> {
        return appRepository.getLoanHoldingCurrent()
    }
