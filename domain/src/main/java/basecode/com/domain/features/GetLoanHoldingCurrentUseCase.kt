...
class GetLoanHoldingCurrentUseCase(useCaseExecution: UseCaseExecution, private val appRepository: AppRepository) : UseCaseOutput<List<NewNewsResponse>, ErrorResponse>(useCaseExecution) {
