...
class GetListNewNewsUseCase(useCaseExecution: UseCaseExecution, private val appRepository: AppRepository) : UseCase<Int, List<NewNewsResponse>, ErrorResponse>(useCaseExecution) {
