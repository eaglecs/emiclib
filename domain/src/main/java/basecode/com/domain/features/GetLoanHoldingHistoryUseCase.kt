...
class GetLoanHoldingHistoryUseCase(useCaseExecution: UseCaseExecution, private val appRepository: AppRepository) : UseCaseOutput<List<NewNewsResponse>, ErrorResponse>(useCaseExecution) {
