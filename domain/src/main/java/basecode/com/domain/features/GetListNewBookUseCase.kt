...
class GetListNewBookUseCase(useCaseExecution: UseCaseExecution, private val appRepository: AppRepository) : UseCase<NewEBookRequest, List<NewBookResponse>, ErrorResponse>(useCaseExecution) {
    override fun buildUseCaseObservable(input: NewEBookRequest): Observable<List<NewBookResponse>> {
