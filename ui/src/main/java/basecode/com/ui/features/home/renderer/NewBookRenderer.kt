...
class NewBookRenderer(private val context: Context, private val onActionClickBook: (NewBookItemViewHolderModel) -> Unit, private val onActionReadMore: () -> Unit) : ViewHolderRenderer<NewBookViewHolderModel>() {
