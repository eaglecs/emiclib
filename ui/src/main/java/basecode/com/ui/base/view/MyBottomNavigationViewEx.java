package basecode.com.ui.base.view;
 ...
 */
public class MyBottomNavigationViewEx extends BottomNavigationView {
    // used for animation
    ...
    private MyBottomNavigationViewExOnPageChangeListener mPageChangeListener;
    ...
    public MyBottomNavigationViewEx setIconVisibility(boolean visibility) {
        /*
...
//                            System.out.println("mIcon.getMeasuredHeight():" + mIcon.getMeasuredHeight());
     ...
     */
    @SuppressLint("RestrictedApi")
    public MyBottomNavigationViewEx setTextVisibility(boolean visibility) {
...
//            System.out.println("mLargeLabel.getMeasuredHeight():" + getFontHeight(mSmallLabelSize));
     ...
     */
    @SuppressLint("RestrictedApi")
    public MyBottomNavigationViewEx enableAnimation(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//                System.out.println("mLargeLabel:" + mLargeLabelSize);
     ...
     */
    @Deprecated
    public MyBottomNavigationViewEx enableShiftingMode(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//        mMenuView.updateMenuView();
     ...
     */
    @Deprecated
    public MyBottomNavigationViewEx enableItemShiftingMode(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//        mMenuView.updateMenuView();
     ...
     */
    public MyBottomNavigationViewEx setCurrentItem(int index) {
     ...
     */
    @SuppressLint("RestrictedApi")
    public MyBottomNavigationViewEx setSmallTextSize(float sp) {
     ...
     */
    @SuppressLint("RestrictedApi")
    public MyBottomNavigationViewEx setLargeTextSize(float sp) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @param sp
     */
    public MyBottomNavigationViewEx setTextSize(float sp) {
        setLargeTextSize(sp);
        setSmallTextSize(sp);
        return this;
    }
     ...
     */
    @SuppressLint("RestrictedApi")
    public MyBottomNavigationViewEx setIconSizeAt(int position, float width, float height) {
     ...
     * @param height in dp
     */
    public MyBottomNavigationViewEx setIconSize(float width, float height) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @param dpSize in dp
     */
    public MyBottomNavigationViewEx setIconSize(float dpSize) {
     ...
     */
    @SuppressLint("RestrictedApi")
    public MyBottomNavigationViewEx setItemHeight(int height) {
        // 1. get mMenuView
        final BottomNavigationMenuView mMenuView = getBottomNavigationMenuView();
     ...
     */
    @SuppressLint("RestrictedApi")
    public MyBottomNavigationViewEx setTypeface(Typeface typeface, int style) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     */
    @SuppressLint("RestrictedApi")
    public MyBottomNavigationViewEx setTypeface(Typeface typeface) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
    ...
    /**
     * This method will link the given ViewPager and this MyBottomNavigationViewEx together so that
     ...
     */
    public MyBottomNavigationViewEx setupWithViewPager(final ViewPager viewPager, boolean smoothScroll) {
        if (mViewPager != null) {
        ...
        if (mPageChangeListener == null) {
            mPageChangeListener = new MyBottomNavigationViewExOnPageChangeListener(this);
        }
     ...
     * necessary calls back to the provided {@link MyBottomNavigationViewEx} so that the tab position is
     * kept in sync.
     * <p>
     * <p>This class stores the provided MyBottomNavigationViewEx weakly, meaning that you can use
     * {@link ViewPager#addOnPageChangeListener(ViewPager.OnPageChangeListener)
     * addOnPageChangeListener(OnPageChangeListener)} without removing the listener and
     * not cause a leak.
     */
    private static class MyBottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<MyBottomNavigationViewEx> mBnveRef;

        public MyBottomNavigationViewExOnPageChangeListener(MyBottomNavigationViewEx bnve) {
        ...
        public void onPageSelected(final int position) {
            final MyBottomNavigationViewEx bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, MyBottomNavigationViewEx bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
...
//            Log.d("onNavigationItemSelecte", "position:"  + position);
    ...
    @SuppressLint("RestrictedApi")
    public MyBottomNavigationViewEx enableShiftingMode(int position, boolean enable) {
        getBottomNavigationItemView(position).setShifting(enable);
        return this;
    }

    @SuppressLint("RestrictedApi")
    public MyBottomNavigationViewEx setItemBackground(int position, int background) {
        getBottomNavigationItemView(position).setItemBackground(background);
        return this;
    }

    @SuppressLint("RestrictedApi")
    public MyBottomNavigationViewEx setIconTintList(int position, ColorStateList tint) {
        getBottomNavigationItemView(position).setIconTintList(tint);
        return this;
    }

    @SuppressLint("RestrictedApi")
    public MyBottomNavigationViewEx setTextTintList(int position, ColorStateList tint) {
     ...
     */
    public MyBottomNavigationViewEx setIconsMarginTop(int marginTop) {
     ...
     */
    @SuppressLint("RestrictedApi")
    public MyBottomNavigationViewEx setIconMarginTop(int position, int marginTop) {
        /*
